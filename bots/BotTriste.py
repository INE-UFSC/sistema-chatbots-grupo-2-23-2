...
class BotTriste(Bot):
    def __init__(self, nome):
        ...
        self.__comandos = [Comando('Bom dia', 'É, até que o dia está sendo bom... Só tenho 10 listas de cálculo pra fazer...Nem chorei hoje ainda...'),
                           Comando(
                               'Quero conselho', 'Se um dia você quiser marcar um fut com os amigos, marque antes das 22h...Num dia que não está chovendo também... '),
                           Comando(
                               'Por que triste?', 'Zerei a prova de calculo ontem, a morena me deixou semana passada e eu pisei num lego hoje de manhã... Pior dia da minha vida')
                           ]
