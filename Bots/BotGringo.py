...
class BotGringo(Bot):
    def __init__(self, nome):
        ...
        self.__comandos = [Comando("Bom dia", "Bom dia for you too minha amigo! Lets buy coisas real is really barato"),
                           Comando(
                               'Quero conselho', 'Continuar morando em Brasil my friend!! Aqui is really good para viver you know, you have caipirinha, samba e futebol every day!'),
                           Comando(
                               'Por que gringo?', 'Eu vim para Brasil to visit the praias of Rio de Janeiro, like Copacabana and Lebron! Brasil has the most bonita capital of the mundo')
                           ]
